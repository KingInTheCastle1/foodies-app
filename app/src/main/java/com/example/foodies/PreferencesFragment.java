...
public class PreferencesFragment extends Fragment {
    ...
    private void setupFilters() {
        ...
        price1.setIsChecked(ConstantManager.CHECK_BOX_CHECKED_FALSE);
        ...
        genre1.setIsChecked(ConstantManager.CHECK_BOX_CHECKED_FALSE);

        SubCategoryItem genre2 = new SubCategoryItem("2","Cafe");
        genre2.setIsChecked(ConstantManager.CHECK_BOX_CHECKED_FALSE);

        SubCategoryItem genre3 = new SubCategoryItem("3","Mexican/Hispanic");
        genre3.setIsChecked(ConstantManager.CHECK_BOX_CHECKED_FALSE);

        SubCategoryItem genre4 = new SubCategoryItem("4","Fast Food");
        genre4.setIsChecked(ConstantManager.CHECK_BOX_CHECKED_FALSE);

        SubCategoryItem genre5 = new SubCategoryItem("5","Pizza");
        genre5.setIsChecked(ConstantManager.CHECK_BOX_CHECKED_FALSE);

        SubCategoryItem genre6 = new SubCategoryItem("6","Italian");
        genre6.setIsChecked(ConstantManager.CHECK_BOX_CHECKED_FALSE);

        SubCategoryItem genre7 = new SubCategoryItem("7","Sandwiches");
        genre7.setIsChecked(ConstantManager.CHECK_BOX_CHECKED_FALSE);

        SubCategoryItem genre8 = new SubCategoryItem("8","Burgers");
        genre8.setIsChecked(ConstantManager.CHECK_BOX_CHECKED_FALSE);

        SubCategoryItem genre9 = new SubCategoryItem("9","Dessert");
        genre9.setIsChecked(ConstantManager.CHECK_BOX_CHECKED_FALSE);

        SubCategoryItem genre10 = new SubCategoryItem("10","Chicken/Wings");
        genre10.setIsChecked(ConstantManager.CHECK_BOX_CHECKED_FALSE);

        SubCategoryItem genre11 = new SubCategoryItem("11","American");
        genre11.setIsChecked(ConstantManager.CHECK_BOX_CHECKED_FALSE);

        SubCategoryItem genre12 = new SubCategoryItem("12","Bar");
        genre12.setIsChecked(ConstantManager.CHECK_BOX_CHECKED_FALSE);

        SubCategoryItem genre13 = new SubCategoryItem("13","Foreign");
        genre13.setIsChecked(ConstantManager.CHECK_BOX_CHECKED_FALSE);

        SubCategoryItem genre14 = new SubCategoryItem("14","Seafood");
        genre14.setIsChecked(ConstantManager.CHECK_BOX_CHECKED_FALSE);

        SubCategoryItem genre15 = new SubCategoryItem("15","Bakery");
        genre15.setIsChecked(ConstantManager.CHECK_BOX_CHECKED_FALSE);

        SubCategoryItem genre16 = new SubCategoryItem("16","Other");
        genre16.setIsChecked(ConstantManager.CHECK_BOX_CHECKED_FALSE);
